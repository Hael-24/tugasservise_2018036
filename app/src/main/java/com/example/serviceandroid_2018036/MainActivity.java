...
public class MainActivity extends AppCompatActivity implements MusicStoppedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceIntent = new Intent(this, com.example.serviceandroid_2018036.MyPlayService.class);
        com.example.serviceandroid_2018036.ApplicationClass.context = (Context) MainActivity.this;
